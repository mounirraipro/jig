        ...
        <div className="h-full flex flex-col bg-white rounded-2xl overflow-hidden border border-slate-200 shadow-sm">
            ...
            <div className="shrink-0 px-4 pt-4 pb-3 border-b border-slate-100">
                <div className="flex items-center justify-between mb-3">
                    <div>
                        <div className="text-base font-bold text-slate-900">Collections</div>
                ...
                <div className="flex gap-2">
                    ...
                    <button
                        ...
                        className={`flex-1 flex items-center justify-center gap-1.5 px-3 py-2 rounded-lg text-xs font-medium transition-colors ${dailyCompleted
                                    ...
                                    <div className="p-3 flex items-center gap-3">
                                        ...
                                        <div className="flex-1 min-w-0 text-left">
                                            <div className="flex items-center justify-between mb-1">
                                                <div className={`font-semibold text-sm ${isUnlocked ? 'text-slate-800' : 'text-slate-500'}`}>
                                                    {pack.name}
                                                </div>
                        ...
                        <>
                            ...
                            <div className="shrink-0 px-3 py-3 border-b border-slate-100">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <div>
                                        <div className="font-bold text-slate-800 text-sm">{activePack.name}</div>
